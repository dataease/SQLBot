    ...
    <div v-loading="loading" class="flex border" style="height: 428px; border-radius: 6px">
      <div class="p-16 border-r">
        ...
        <div class="mt-8 max-height_workspace">
          <template v-if="workspaceWithKeywords.length">
            <el-checkbox
              v-model="checkAll"
              class="mb-8"
            ...
            >
              ...
              >
                <div class="flex">
                  ...
                  <span class="ml-8 ellipsis" style="max-width: 40%" :title="space.name">
                    {{ space.name }}</span
                  >
                  <span class="account ellipsis ml-8" style="max-width: 40%" :title="space.account"
                    >({{ space.account }})</span
                  >
                </div>
              </el-checkbox>
          ...
          <div v-else class="ed-tree__empty-block">
...
const open = async (id: any) => {
  dialogTitle.value = 'sync.sync_wechat_users'
  loading.value = true
  search.value = ''
  oid = id
